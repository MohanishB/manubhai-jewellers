  ...
  Widget _freezeControl(ProductModel product) {
      ...
      return InkWell(
        ...
        child: Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            const Icon(Icons.ac_unit, color: Colors.white, size: 13), const SizedBox(width: 4),
    ...
    return BlocConsumer<FreezeProductBloc, FreezeProductState>(
      ...
      builder: (context, state) {
        ...
        return SizedBox(height:28,child:ElevatedButton.icon(
          style:ElevatedButton.styleFrom(backgroundColor:AppColors.success,foregroundColor:AppColors.surface,padding:const EdgeInsets.symmetric(horizontal:8),minimumSize:const Size(0,28),textStyle:const TextStyle(fontSize:10,fontWeight:FontWeight.w800)),
          onPressed:busy||cseId.isEmpty?null:()=>context.read<FreezeProductBloc>().add(FreezeProductRequested(cseId:cseId,stockCode:product.stockCode)),
          icon:busy?const SizedBox(width:12,height:12,child:CircularProgressIndicator(strokeWidth:2,color:AppColors.surface)):const Icon(Icons.ac_unit,size:13),
